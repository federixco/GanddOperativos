...
def round_robin_blocking(process_list, quantum):
    """Round Robin con bloqueos, ejecución por tramos con actualización correcta de bursts."""
    ...
    def enqueue_arrivals_leq_t(t):
        """Encola llegadas hasta t (incluido) con prioridad de llegada."""
        nonlocal completed
        for p in processes:
            if p.pid in arrived:
                continue
    ...
    while completed < n:
        ...
        # Procesar eventos durante la ejecución
